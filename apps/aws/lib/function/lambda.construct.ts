...
export function createLambdas(
  ...
  const reportsMainStoreLambda = new NodejsFunction(
    scope,
    `${envName}-generate-reports`,
    {
      ...
      environment: {
        ...
        ORDER_AUDIT_TRAIL_TABLE:
          tables.analyticsTables.orderAuditTrailTable.tableName,
        ...
        CALCULATED_ITEM_ORDER_TABLE:
          tables.storeTables.calculatedItemOrderTable.tableName,
      },
    },
  );

  tables.analyticsTables.orderAuditTrailTable.grantReadData(
    reportsMainStoreLambda,
  );
  ...
  tables.storeTables.calculatedItemOrderTable.grantReadData(
    reportsMainStoreLambda,
  );
  ...
  const imageOptimizationLambda = new NodejsFunction(
    scope,
    `${envName}-optimize-images`,
    {
  ...
  buckets.filesBucket.addObjectCreatedNotification(
    new LambdaDestination(imageOptimizationLambda),
  );
}
